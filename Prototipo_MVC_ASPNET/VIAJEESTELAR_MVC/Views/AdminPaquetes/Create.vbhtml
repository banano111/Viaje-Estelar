                    ...
                    <div class="card-body">
                        <form>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-text">URL De la Imagen a Registrar en el Paquete</div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" value="" data-val="true" data-val-date="El campo Fecha debe ser una fecha." id="Fecha" name="Fecha" class="form-control" />
